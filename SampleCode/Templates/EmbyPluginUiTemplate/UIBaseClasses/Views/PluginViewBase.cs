...
namespace EmbyPluginUiTemplate.UIBaseClasses.Views
{
    internal abstract class PluginViewBase : IPluginUIView, IPluginViewWithOptions
    {
        ...
        ///         mouse-clicking or tapping outside of the wizard window.
        ///   </para>
        ...
        ///         <see cref="F:MediaBrowser.Model.Plugins.UI.Views.Enums.WizardHidingBehavior.AutoCancel" /> as there is no state that
