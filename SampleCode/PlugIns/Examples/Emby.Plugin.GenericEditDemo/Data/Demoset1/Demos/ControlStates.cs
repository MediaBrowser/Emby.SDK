// <copyright file="ControlStates.cs" company="Emby LLC">
...
namespace Emby.Plugin.GenericEditDemo.Data.Demoset1.Demos
{
    ...
    public class ControlStates : EditableOptionsBase
    {
        ...
        public override string EditorDescription =>
            ...
            + "the disabled state is determined dynamically. See 'Conditions' for further details.";
        ...
        [Description("This is the description.")]
        [ReadOnly(true)]
        public VideoCodecTypes SimpleEnumSelect1 { get; set; }

        [DisplayName("Multi-Select - Normal")]
        [Description("This is the description.")]
        [EditMultilSelect]
        public VideoCodecTypes MultiEnumSelect { get; set; }

        [DisplayName("Multi-Select - ReadOnly")]
        [Description("This is the description.")]
        [EditMultilSelect]
        [ReadOnly(true)]
        public VideoCodecTypes MultiEnumSelect1 { get; set; }
