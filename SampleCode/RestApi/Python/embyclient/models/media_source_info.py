...
class MediaSourceInfo(object):
    ...
    swagger_types = {
        ...
        'id': 'str',
        'path': 'str',
        'convert_url_credentials_to_basic_auth': 'bool',
        'encoder_path': 'str',
    ...
    attribute_map = {
        ...
        'id': 'Id',
        'path': 'Path',
        'convert_url_credentials_to_basic_auth': 'ConvertUrlCredentialsToBasicAuth',
    ...
    def __init__(self, chapters=None, protocol=None, id=None, path=None, convert_url_credentials_to_basic_auth=None, encoder_path=None, encoder_protocol=None, type=None, probe_path=None, probe_protocol=None, container=None, size=None, name=None, sort_name=None, is_remote=None, has_mixed_protocols=None, run_time_ticks=None, container_start_time_ticks=None, supports_transcoding=None, trancode_live_start_index=None, wall_clock_start=None, supports_direct_stream=None, supports_direct_play=None, is_infinite_stream=None, requires_opening=None, open_token=None, requires_closing=None, live_stream_id=None, buffer_ms=None, requires_looping=None, supports_probing=None, video3_d_format=None, media_streams=None, formats=None, bitrate=None, timestamp=None, required_http_headers=None, direct_stream_url=None, add_api_key_to_direct_stream_url=None, transcoding_url=None, transcoding_sub_protocol=None, transcoding_container=None, analyze_duration_ms=None, read_at_native_framerate=None, default_audio_stream_index=None, default_subtitle_stream_index=None, item_id=None, server_id=None):  # noqa: E501
        ...
        if path is not None:
            self.path = path
        if convert_url_credentials_to_basic_auth is not None:
            self.convert_url_credentials_to_basic_auth = convert_url_credentials_to_basic_auth
    ...
    @property
    def convert_url_credentials_to_basic_auth(self):
        """Gets the convert_url_credentials_to_basic_auth of this MediaSourceInfo.  # noqa: E501


        :return: The convert_url_credentials_to_basic_auth of this MediaSourceInfo.  # noqa: E501
        :rtype: bool
        """
        return self._convert_url_credentials_to_basic_auth

    @convert_url_credentials_to_basic_auth.setter
    def convert_url_credentials_to_basic_auth(self, convert_url_credentials_to_basic_auth):
        """Sets the convert_url_credentials_to_basic_auth of this MediaSourceInfo.


        :param convert_url_credentials_to_basic_auth: The convert_url_credentials_to_basic_auth of this MediaSourceInfo.  # noqa: E501
        :type: bool
        """

        self._convert_url_credentials_to_basic_auth = convert_url_credentials_to_basic_auth
