//
// RemoteSearchQueryAlbumInfo.swift
//
...
public struct RemoteSearchQueryAlbumInfo: Codable {
    ...
    public init(searchInfo: AlbumInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, providers: [String]? = nil, includeDisabledProviders: Bool? = nil) {
