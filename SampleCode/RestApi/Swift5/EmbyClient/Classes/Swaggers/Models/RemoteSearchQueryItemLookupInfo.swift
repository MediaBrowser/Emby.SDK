//
// RemoteSearchQueryItemLookupInfo.swift
//
...
public struct RemoteSearchQueryItemLookupInfo: Codable {

    public var searchInfo: ItemLookupInfo?
    public var itemId: Int64?
    public var searchProviderName: String?
    public var providers: [String]?
    public var includeDisabledProviders: Bool?

    public init(searchInfo: ItemLookupInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, providers: [String]? = nil, includeDisabledProviders: Bool? = nil) {
