// <copyright file="ContentServiceApi.cs" company="Emby LLC">
...
namespace Emby.ApiClient.Api
{
    ...
    /// </summary>
    public partial class ContentServiceApi : IApiAccessor
    {
        /// <summary>
        ...
        public async Task<RestResponse<List<ContentSection>>> GetUsersByUseridHomesections (string userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new ApiException("Missing required parameter 'userId' when calling ContentServiceApi->GetUsersByUseridHomesections");
            }
            
            var request = new RestRequest("/Users/{UserId}/HomeSections", Method.Get);
            ...
            var localVarResponse = await this.ApiClient.RestClient.ExecuteAsync<List<ContentSection>>(request).ConfigureAwait(false);
