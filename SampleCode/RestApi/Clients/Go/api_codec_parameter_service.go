...
@return EmbyWebGenericEditEditObjectContainer
*/
func (a *CodecParameterServiceApiService) GetEncodingdiagnosticsCodecparameters(ctx context.Context, codecId string, parameterContext MediaEncodingCodecParameterContext) (EmbyWebGenericEditEditObjectContainer, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/EncodingDiagnostics/CodecParameters"
...
*/
func (a *CodecParameterServiceApiService) PostEncodingdiagnosticsCodecparameters(ctx context.Context, body Object, codecId string, parameterContext MediaEncodingCodecParameterContext) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
