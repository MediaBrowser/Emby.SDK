 ...
 * @param optional nil or *VideoHlsServiceApiGetAudioByIdLiveM3u8Opts - Optional Parameters:
...
type VideoHlsServiceApiGetAudioByIdLiveM3u8Opts struct {
...
func (a *VideoHlsServiceApiService) GetAudioByIdLiveM3u8(ctx context.Context, id string, container string, localVarOptionals *VideoHlsServiceApiGetAudioByIdLiveM3u8Opts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
