...
namespace Emby.ApiClient.Api
{
    ...
    public partial class TvShowsServiceApi : IApiAccessor
    {
        ...
        public async Task<RestResponse<QueryResultBaseItemDto>> GetShowsByIdSeasons (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new ApiException("Missing required parameter 'userId' when calling TvShowsServiceApi->GetShowsByIdSeasons");
            }
        ...
        /// <param name="enableUserData">Optional, include user data (optional)</param>
        /// <returns>Task of ApiResponse (QueryResultBaseItemDto)</returns>
        public async Task<RestResponse<QueryResultBaseItemDto>> GetShowsUpcoming (string userId, int? startIndex, int? limit, string fields, string parentId, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
            {
                throw new ApiException("Missing required parameter 'userId' when calling TvShowsServiceApi->GetShowsUpcoming");
            }
