...
namespace EmbyClient.MsRest.Models
{
    ...
    public partial class UpdatesPackageInfo
    {
        ...
        public UpdatesPackageInfo(string id = default(string), string name = default(string), string shortDescription = default(string), string overview = default(string), bool? isPremium = default(bool?), bool? adult = default(bool?), string richDescUrl = default(string), string thumbImage = default(string), string previewImage = default(string), string type = default(string), string targetFilename = default(string), string owner = default(string), string category = default(string), string tileColor = default(string), string featureId = default(string), double? price = default(double?), string targetSystem = default(string), string guid = default(string), bool? isRegistered = default(bool?), System.DateTime? expDate = default(System.DateTime?), IList<UpdatesPackageVersionInfo> versions = default(IList<UpdatesPackageVersionInfo>), bool? enableInAppStore = default(bool?), int? installs = default(int?))
        {
            Id = id;
            Name = name;
