...
namespace EmbyClient.MsRest.Models
{
    ...
    public partial class ProvidersArtistInfo
    {
        /// <summary>
        /// Initializes a new instance of the ProvidersArtistInfo class.
        /// </summary>
        ...
        /// Initializes a new instance of the ProvidersArtistInfo class.
        /// </summary>
        public ProvidersArtistInfo(string name = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), IList<GlobalizationCultureDto> metadataLanguages = default(IList<GlobalizationCultureDto>), IDictionary<string, string> providerIds = default(IDictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), System.DateTime? premiereDate = default(System.DateTime?), bool? isAutomated = default(bool?), bool? enableAdultMetadata = default(bool?))
        {
            Name = name;
