...
namespace EmbyClient.MsRest.Models
{
    ...
    public partial class BaseItemDto
    {
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "CanManageAccess")]
        public bool? CanManageAccess { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "CanMakePrivate")]
        public bool? CanMakePrivate { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "CanMakePublic")]
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "InheritedPrimaryImageItemId")]
        public string InheritedPrimaryImageItemId { get; set; }

        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "InheritedPrimaryImageTag")]
