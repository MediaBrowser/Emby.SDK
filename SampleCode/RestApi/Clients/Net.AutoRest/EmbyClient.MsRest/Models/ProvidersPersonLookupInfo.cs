...
namespace EmbyClient.MsRest.Models
{
    ...
    public partial class ProvidersPersonLookupInfo
    {
        ...
        /// Initializes a new instance of the ProvidersPersonLookupInfo class.
        /// </summary>
        public ProvidersPersonLookupInfo(string name = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), IDictionary<string, string> providerIds = default(IDictionary<string, string>), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), System.DateTime? premiereDate = default(System.DateTime?), bool? isAutomated = default(bool?), bool? enableAdultMetadata = default(bool?))
        {
            Name = name;
