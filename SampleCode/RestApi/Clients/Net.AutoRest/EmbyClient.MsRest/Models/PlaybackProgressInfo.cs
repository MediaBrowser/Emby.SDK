...
namespace EmbyClient.MsRest.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the PlaybackProgressInfo class.
        /// </summary>
        ...
        public PlaybackProgressInfo(bool? canSeek = default(bool?), BaseItemDto item = default(BaseItemDto), IList<QueueItem> nowPlayingQueue = default(IList<QueueItem>), string playlistItemId = default(string), string itemId = default(string), string sessionId = default(string), string mediaSourceId = default(string), int? audioStreamIndex = default(int?), int? subtitleStreamIndex = default(int?), bool? isPaused = default(bool?), int? playlistIndex = default(int?), int? playlistLength = default(int?), bool? isMuted = default(bool?), long? positionTicks = default(long?), long? runTimeTicks = default(long?), long? playbackStartTimeTicks = default(long?), int? volumeLevel = default(int?), int? brightness = default(int?), string aspectRatio = default(string), string eventName = default(string), string playMethod = default(string), string liveStreamId = default(string), string playSessionId = default(string), string repeatMode = default(string), int? subtitleOffset = default(int?), double? playbackRate = default(double?), IList<string> playlistItemIds = default(IList<string>))
        {
            CanSeek = canSeek;
            Item = item;
