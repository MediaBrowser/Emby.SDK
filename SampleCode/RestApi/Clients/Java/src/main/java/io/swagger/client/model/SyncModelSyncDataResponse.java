...
public class SyncModelSyncDataResponse {
  @SerializedName("ItemIdsToRemove")
  private List<String> itemIdsToRemove = null;

  public SyncModelSyncDataResponse itemIdsToRemove(List<String> itemIdsToRemove) {
    this.itemIdsToRemove = itemIdsToRemove;
    return this;
  }

  public SyncModelSyncDataResponse addItemIdsToRemoveItem(String itemIdsToRemoveItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SyncModelSyncDataResponse syncModelSyncDataResponse = (SyncModelSyncDataResponse) o;
    return Objects.equals(this.itemIdsToRemove, syncModelSyncDataResponse.itemIdsToRemove);
  }
