...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersItemLookupInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersItemLookupInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersItemLookupInfo(ProvidersItemLookupInfo searchInfo = default(ProvidersItemLookupInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
