...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQueryBookInfo :  IEquatable<RemoteSearchQueryBookInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQueryBookInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQueryBookInfo(BookInfo searchInfo = default(BookInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoteSearchQueryBookInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQueryBookInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQueryBookInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQueryBookInfo input)
        {
            if (input == null)
                return false;
