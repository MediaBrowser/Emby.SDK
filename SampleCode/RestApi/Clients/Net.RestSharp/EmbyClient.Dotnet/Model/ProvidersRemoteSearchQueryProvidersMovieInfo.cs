...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersMovieInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersMovieInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersMovieInfo(ProvidersMovieInfo searchInfo = default(ProvidersMovieInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
