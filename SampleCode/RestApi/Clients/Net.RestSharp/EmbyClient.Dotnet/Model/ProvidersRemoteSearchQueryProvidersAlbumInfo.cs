...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersAlbumInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersAlbumInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersAlbumInfo(ProvidersAlbumInfo searchInfo = default(ProvidersAlbumInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
