...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EditorsEditorBase :  IEquatable<EditorsEditorBase>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EditorsEditorBase" /> class.
        /// </summary>
        ...
        public EditorsEditorBase(CommonEditorTypes editorType = default(CommonEditorTypes), string name = default(string), string id = default(string), bool? allowEmpty = default(bool?), bool? isReadOnly = default(bool?), bool? isAdvanced = default(bool?), string displayName = default(string), string description = default(string), string parentId = default(string))
        {
        ...
        {
            return this.Equals(input as EditorsEditorBase);
        }

        /// <summary>
        /// Returns true if EditorsEditorBase instances are equal
        /// </summary>
        /// <param name="input">Instance of EditorsEditorBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EditorsEditorBase input)
        {
            if (input == null)
                return false;
