...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersTrailerInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersTrailerInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersTrailerInfo(ProvidersTrailerInfo searchInfo = default(ProvidersTrailerInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
