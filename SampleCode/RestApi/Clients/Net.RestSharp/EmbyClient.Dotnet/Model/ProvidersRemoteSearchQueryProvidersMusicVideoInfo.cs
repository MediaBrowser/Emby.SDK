...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersMusicVideoInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersMusicVideoInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersMusicVideoInfo(ProvidersMusicVideoInfo searchInfo = default(ProvidersMusicVideoInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
