...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersBookInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersBookInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersBookInfo(ProvidersBookInfo searchInfo = default(ProvidersBookInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
