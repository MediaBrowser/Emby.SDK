...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQueryItemLookupInfo :  IEquatable<RemoteSearchQueryItemLookupInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQueryItemLookupInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQueryItemLookupInfo(ItemLookupInfo searchInfo = default(ItemLookupInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ItemLookupInfo SearchInfo { get; set; }
        ...
        {
            return this.Equals(input as RemoteSearchQueryItemLookupInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQueryItemLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQueryItemLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQueryItemLookupInfo input)
        {
            if (input == null)
                return false;
