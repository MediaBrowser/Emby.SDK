...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQueryTrailerInfo :  IEquatable<RemoteSearchQueryTrailerInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQueryTrailerInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQueryTrailerInfo(TrailerInfo searchInfo = default(TrailerInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoteSearchQueryTrailerInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQueryTrailerInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQueryTrailerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQueryTrailerInfo input)
        {
            if (input == null)
                return false;
