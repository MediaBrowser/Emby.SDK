...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQueryMusicVideoInfo :  IEquatable<RemoteSearchQueryMusicVideoInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQueryMusicVideoInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQueryMusicVideoInfo(MusicVideoInfo searchInfo = default(MusicVideoInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoteSearchQueryMusicVideoInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQueryMusicVideoInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQueryMusicVideoInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQueryMusicVideoInfo input)
        {
            if (input == null)
                return false;
