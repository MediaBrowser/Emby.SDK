...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class RemoteSearchQueryMovieInfo :  IEquatable<RemoteSearchQueryMovieInfo>
    {
        ...
        public RemoteSearchQueryMovieInfo(MovieInfo searchInfo = default(MovieInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
