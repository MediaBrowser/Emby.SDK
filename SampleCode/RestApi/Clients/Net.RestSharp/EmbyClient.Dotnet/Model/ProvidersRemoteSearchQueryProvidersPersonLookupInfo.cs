...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersPersonLookupInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersPersonLookupInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersPersonLookupInfo(ProvidersPersonLookupInfo searchInfo = default(ProvidersPersonLookupInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
