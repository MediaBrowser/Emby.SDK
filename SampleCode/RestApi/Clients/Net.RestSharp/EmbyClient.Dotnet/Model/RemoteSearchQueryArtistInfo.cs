...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class RemoteSearchQueryArtistInfo :  IEquatable<RemoteSearchQueryArtistInfo>
    {
        ...
        public RemoteSearchQueryArtistInfo(ArtistInfo searchInfo = default(ArtistInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
