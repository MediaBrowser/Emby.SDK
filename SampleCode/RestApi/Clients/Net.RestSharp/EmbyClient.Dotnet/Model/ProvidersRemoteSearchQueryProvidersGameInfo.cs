...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersGameInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersGameInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersGameInfo(ProvidersGameInfo searchInfo = default(ProvidersGameInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
