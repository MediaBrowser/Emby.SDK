...
namespace EmbyClient.Dotnet.Model
{
        ...
        public partial class ProvidersRemoteSearchQueryProvidersArtistInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersArtistInfo>
    {
        ...
        public ProvidersRemoteSearchQueryProvidersArtistInfo(ProvidersArtistInfo searchInfo = default(ProvidersArtistInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
