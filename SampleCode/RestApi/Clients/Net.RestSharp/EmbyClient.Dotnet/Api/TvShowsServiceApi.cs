...
namespace EmbyClient.Dotnet.Api
{
        ...
        public interface ITvShowsServiceApi : IApiAccessor
    {
        ...
        QueryResultBaseItemDto GetShowsByIdSeasons (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData);
        ...
        ApiResponse<QueryResultBaseItemDto> GetShowsByIdSeasonsWithHttpInfo (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData);
        /// <summary>
        ...
        System.Threading.Tasks.Task<QueryResultBaseItemDto> GetShowsByIdSeasonsAsync (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData);
        ...
        System.Threading.Tasks.Task<ApiResponse<QueryResultBaseItemDto>> GetShowsByIdSeasonsAsyncWithHttpInfo (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData);
        /// <summary>
        /// Gets a list of next up episodes
        /// </summary>
        /// <remarks>
        ...
        public partial class TvShowsServiceApi : ITvShowsServiceApi
    {
        ...
        /// <param name="enableUserData">Optional, include user data (optional)</param>
        /// <returns>QueryResultBaseItemDto</returns>
        public QueryResultBaseItemDto GetShowsByIdSeasons (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData)
        {
             ApiResponse<QueryResultBaseItemDto> localVarResponse = GetShowsByIdSeasonsWithHttpInfo(userId, fields, id, isSpecialSeason, isMissing, adjacentTo, enableImages, imageTypeLimit, enableImageTypes, enableUserData);
        ...
        /// <param name="enableUserData">Optional, include user data (optional)</param>
        /// <returns>ApiResponse of QueryResultBaseItemDto</returns>
        public ApiResponse< QueryResultBaseItemDto > GetShowsByIdSeasonsWithHttpInfo (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData)
        {
        ...
        /// <param name="enableUserData">Optional, include user data (optional)</param>
        /// <returns>Task of QueryResultBaseItemDto</returns>
        public async System.Threading.Tasks.Task<QueryResultBaseItemDto> GetShowsByIdSeasonsAsync (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData)
        {
             ApiResponse<QueryResultBaseItemDto> localVarResponse = await GetShowsByIdSeasonsAsyncWithHttpInfo(userId, fields, id, isSpecialSeason, isMissing, adjacentTo, enableImages, imageTypeLimit, enableImageTypes, enableUserData);
             return localVarResponse.Data;
        ...
        /// <param name="enableUserData">Optional, include user data (optional)</param>
        /// <returns>Task of ApiResponse (QueryResultBaseItemDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<QueryResultBaseItemDto>> GetShowsByIdSeasonsAsyncWithHttpInfo (string userId, string fields, string id, bool? isSpecialSeason, bool? isMissing, string adjacentTo, bool? enableImages, int? imageTypeLimit, string enableImageTypes, bool? enableUserData)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling TvShowsServiceApi->GetShowsByIdSeasons");
