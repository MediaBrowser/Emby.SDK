...
namespace EmbyClient.Dotnet.Beta.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericUIModelUITabPageInfo :  IEquatable<EmbyWebGenericUIModelUITabPageInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericUIModelUITabPageInfo" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EmbyWebGenericUIModelUITabPageInfo);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericUIModelUITabPageInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericUIModelUITabPageInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericUIModelUITabPageInfo input)
        {
            if (input == null)
                return false;
