...
namespace EmbyClient.Dotnet.Beta.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericUIModelUIViewInfo :  IEquatable<EmbyWebGenericUIModelUIViewInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericUIModelUIViewInfo" /> class.
        /// </summary>
        ...
        public EmbyWebGenericUIModelUIViewInfo(string viewId = default(string), string pageId = default(string), string caption = default(string), string subCaption = default(string), string pluginId = default(string), EmbyWebGenericUIModelEnumsUIViewType viewType = default(EmbyWebGenericUIModelEnumsUIViewType), bool? showDialogFullScreen = default(bool?), bool? isInSequence = default(bool?), string redirectViewUrl = default(string), GenericEditIEditObjectContainer editObjectContainer = default(GenericEditIEditObjectContainer), List<EmbyWebGenericUIModelUICommand> commands = default(List<EmbyWebGenericUIModelUICommand>), List<EmbyWebGenericUIModelUITabPageInfo> tabPageInfos = default(List<EmbyWebGenericUIModelUITabPageInfo>), bool? isPageChangeInfo = default(bool?))
        {
            this.ViewId = viewId;
            this.PageId = pageId;
        ...
        public EmbyWebGenericUIModelEnumsUIViewType ViewType { get; set; }
        ...
        public List<EmbyWebGenericUIModelUICommand> Commands { get; set; }

        /// <summary>
        /// Gets or Sets TabPageInfos
        /// </summary>
        [DataMember(Name="TabPageInfos", EmitDefaultValue=false)]
        public List<EmbyWebGenericUIModelUITabPageInfo> TabPageInfos { get; set; }
        ...
        {
            return this.Equals(input as EmbyWebGenericUIModelUIViewInfo);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericUIModelUIViewInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericUIModelUIViewInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericUIModelUIViewInfo input)
        {
            if (input == null)
                return false;
