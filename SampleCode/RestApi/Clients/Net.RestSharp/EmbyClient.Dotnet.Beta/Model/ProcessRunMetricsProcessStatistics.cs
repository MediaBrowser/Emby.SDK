...
namespace EmbyClient.Dotnet.Beta.Model
{
        ...
        public partial class ProcessRunMetricsProcessStatistics :  IEquatable<ProcessRunMetricsProcessStatistics>
    {
        ...
        /// </summary>
        /// <param name="currentCpu">currentCpu.</param>
        /// <param name="averageCpu">averageCpu.</param>
        /// <param name="currentVirtualMemory">currentVirtualMemory.</param>
        /// <param name="currentWorkingSet">currentWorkingSet.</param>
