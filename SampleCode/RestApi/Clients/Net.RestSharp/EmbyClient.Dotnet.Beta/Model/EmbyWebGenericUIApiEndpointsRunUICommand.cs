...
namespace EmbyClient.Dotnet.Beta.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericUIApiEndpointsRunUICommand :  IEquatable<EmbyWebGenericUIApiEndpointsRunUICommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericUIApiEndpointsRunUICommand" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EmbyWebGenericUIApiEndpointsRunUICommand);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericUIApiEndpointsRunUICommand instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericUIApiEndpointsRunUICommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericUIApiEndpointsRunUICommand input)
        {
            if (input == null)
                return false;
