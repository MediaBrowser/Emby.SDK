...
namespace EmbyClient.Dotnet.Beta.Model
{
        ...
        public partial class ProvidersPersonLookupInfo :  IEquatable<ProvidersPersonLookupInfo>
    {
        ...
        public ProvidersPersonLookupInfo(string name = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), List<GlobalizationCultureDto> metadataLanguages = default(List<GlobalizationCultureDto>), ProviderIdDictionary providerIds = default(ProviderIdDictionary), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTimeOffset? premiereDate = default(DateTimeOffset?), bool? isAutomated = default(bool?), bool? enableAdultMetadata = default(bool?))
        {
            this.Name = name;
