...
namespace EmbyClient.Dotnet.Beta.Model
{
        ...
        public partial class ProvidersAlbumInfo :  IEquatable<ProvidersAlbumInfo>
    {
        ...
        public ProvidersAlbumInfo(List<string> albumArtists = default(List<string>), List<ProvidersSongInfo> songInfos = default(List<ProvidersSongInfo>), string name = default(string), string metadataLanguage = default(string), string metadataCountryCode = default(string), List<GlobalizationCultureDto> metadataLanguages = default(List<GlobalizationCultureDto>), ProviderIdDictionary providerIds = default(ProviderIdDictionary), int? year = default(int?), int? indexNumber = default(int?), int? parentIndexNumber = default(int?), DateTimeOffset? premiereDate = default(DateTimeOffset?), bool? isAutomated = default(bool?), bool? enableAdultMetadata = default(bool?))
        {
