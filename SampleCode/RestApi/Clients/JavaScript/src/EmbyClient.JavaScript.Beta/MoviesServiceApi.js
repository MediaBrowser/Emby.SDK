...
export default class MoviesServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/MoviesServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/MoviesServiceApi~getMoviesRecommendationsCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/MoviesServiceApi~getMoviesRecommendationsCallback} callback The callback function, accepting three arguments: error, data, response
