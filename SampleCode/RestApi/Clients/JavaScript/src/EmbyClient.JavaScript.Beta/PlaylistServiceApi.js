...
export default class PlaylistServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/PlaylistServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~deletePlaylistsByIdItemsCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~deletePlaylistsByIdItemsCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~getPlaylistsByIdItemsCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~getPlaylistsByIdItemsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~postPlaylistsCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~postPlaylistsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~postPlaylistsByIdItemsByItemidMoveByNewindexCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~postPlaylistsByIdItemsByItemidMoveByNewindexCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~postPlaylistsByIdItemsDeleteCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Removes items from a playlist
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/PlaylistServiceApi~postPlaylistsByIdItemsDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
