...
export default class ConnectServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/ConnectServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ConnectServiceApi~deleteUsersByIdConnectLinkCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/ConnectServiceApi~deleteUsersByIdConnectLinkCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ConnectServiceApi~getConnectExchangeCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EmbyClient.JavaScript.Beta/ConnectServiceApi~getConnectExchangeCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ConnectServiceApi~getConnectPendingCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript.Beta/ConnectServiceApi~getConnectPendingCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getConnectPending() {
      let postBody = null;
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ConnectServiceApi~postUsersByIdConnectLinkCallback
     * @param {String} error Error message, if any.
     ...
     * Creates a Connect link for a user
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript.Beta/ConnectServiceApi~postUsersByIdConnectLinkCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ConnectServiceApi~postUsersByIdConnectLinkDeleteCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Removes a Connect link for a user
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript.Beta/ConnectServiceApi~postUsersByIdConnectLinkDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
