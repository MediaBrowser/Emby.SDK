...
export default class AudioServiceApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getAudioByIdByStreamfilename operation.
     * @callback module:EmbyClient.JavaScript.Beta/AudioServiceApi~getAudioByIdByStreamfilenameCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/AudioServiceApi~getAudioByIdByStreamfilenameCallback} callback The callback function, accepting three arguments: error, data, response
     */
    ...
    /**
     * Callback function to receive the result of the headAudioByIdByStreamfilename operation.
     * @callback module:EmbyClient.JavaScript.Beta/AudioServiceApi~headAudioByIdByStreamfilenameCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/AudioServiceApi~headAudioByIdByStreamfilenameCallback} callback The callback function, accepting three arguments: error, data, response
     */
