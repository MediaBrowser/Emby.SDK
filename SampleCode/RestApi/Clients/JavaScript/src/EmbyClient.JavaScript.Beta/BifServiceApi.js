...
export default class BifServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/BifServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/BifServiceApi~getItemsByIdThumbnailsetCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/BifServiceApi~getItemsByIdThumbnailsetCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/BifServiceApi~getVideosByIdIndexBifCallback
     * @param {String} error Error message, if any.
    ...
    /**
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/BifServiceApi~getVideosByIdIndexBifCallback} callback The callback function, accepting three arguments: error, data, response
     */
