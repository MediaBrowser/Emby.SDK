...
export default class BrandingServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/BrandingServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/BrandingServiceApi~getBrandingConfigurationCallback
     ...
     * @callback module:EmbyClient.JavaScript.Beta/BrandingServiceApi~getBrandingCssCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:EmbyClient.JavaScript.Beta/BrandingServiceApi~getBrandingCssCssCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
