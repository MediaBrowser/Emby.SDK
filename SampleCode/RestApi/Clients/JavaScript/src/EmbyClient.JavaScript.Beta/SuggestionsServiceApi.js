...
export default class SuggestionsServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/SuggestionsServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/SuggestionsServiceApi~getUsersByUseridSuggestionsCallback
