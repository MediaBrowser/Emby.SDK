...
export default class BackupApiApi {
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/BackupApiApi~postBackuprestoreRestoredataCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript.Beta/BackupApiApi~postBackuprestoreRestoredataCallback} callback The callback function, accepting three arguments: error, data, response
     */
