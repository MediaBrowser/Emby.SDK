...
export default class DisplayPreferencesServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/DisplayPreferencesServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/DisplayPreferencesServiceApi~getDisplaypreferencesByIdCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/DisplayPreferencesServiceApi~getDisplaypreferencesByIdCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/DisplayPreferencesServiceApi~postDisplaypreferencesByDisplaypreferencesidCallback} callback The callback function, accepting three arguments: error, data, response
     */
