...
export default class PersonsServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/PersonsServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PersonsServiceApi~getPersonsCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/PersonsServiceApi~getPersonsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PersonsServiceApi~getPersonsByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/PersonsServiceApi~getPersonsByNameCallback} callback The callback function, accepting three arguments: error, data, response
