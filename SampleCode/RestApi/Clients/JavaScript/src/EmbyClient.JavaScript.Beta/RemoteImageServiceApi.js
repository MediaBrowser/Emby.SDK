...
export default class RemoteImageServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~getImagesRemoteCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~getImagesRemoteCallback} callback The callback function, accepting three arguments: error, data, response
     */
    getImagesRemote() {
      let postBody = null;
     ...
     * @callback module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~getItemsByIdRemoteimagesCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~getItemsByIdRemoteimagesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~getItemsByIdRemoteimagesProvidersCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~getItemsByIdRemoteimagesProvidersCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~postItemsByIdRemoteimagesDownloadCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Requires authentication as administrator
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/RemoteImageServiceApi~postItemsByIdRemoteimagesDownloadCallback} callback The callback function, accepting three arguments: error, data, response
     */
