...
export default class UserNotificationsServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/UserNotificationsServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/UserNotificationsServiceApi~postNotificationsServicesTestCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/UserNotificationsServiceApi~postNotificationsServicesTestCallback} callback The callback function, accepting three arguments: error, data, response
     */
