...
export default class ItemUpdateServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/ItemUpdateServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ItemUpdateServiceApi~getItemsByItemidMetadataeditorCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/ItemUpdateServiceApi~getItemsByItemidMetadataeditorCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/ItemUpdateServiceApi~postItemsByItemidCallback
     * @param {String} error Error message, if any.
     ...
     * Updates an item
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript.Beta/ItemUpdateServiceApi~postItemsByItemidCallback} callback The callback function, accepting three arguments: error, data, response
     */
    postItemsByItemid() {
      let postBody = body;
