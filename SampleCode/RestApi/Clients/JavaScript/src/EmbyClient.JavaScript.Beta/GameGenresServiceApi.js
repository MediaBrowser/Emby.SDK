...
export default class GameGenresServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/GameGenresServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/GameGenresServiceApi~getGamegenresCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/GameGenresServiceApi~getGamegenresCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/GameGenresServiceApi~getGamegenresByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/GameGenresServiceApi~getGamegenresByNameCallback} callback The callback function, accepting three arguments: error, data, response
