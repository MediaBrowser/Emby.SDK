...
export default class PackageServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/PackageServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PackageServiceApi~deletePackagesInstallingByIdCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/PackageServiceApi~deletePackagesInstallingByIdCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PackageServiceApi~postPackagesInstalledByNameCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Requires authentication as administrator
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/PackageServiceApi~postPackagesInstalledByNameCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/PackageServiceApi~postPackagesInstallingByIdDeleteCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Cancels a package installation
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript.Beta/PackageServiceApi~postPackagesInstallingByIdDeleteCallback} callback The callback function, accepting three arguments: error, data, response
     */
