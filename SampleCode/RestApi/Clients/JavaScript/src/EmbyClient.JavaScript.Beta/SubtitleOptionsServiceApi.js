...
export default class SubtitleOptionsServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/SubtitleOptionsServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/SubtitleOptionsServiceApi~postEncodingSubtitleoptionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EmbyClient.JavaScript.Beta/SubtitleOptionsServiceApi~postEncodingSubtitleoptionsCallback} callback The callback function, accepting three arguments: error, data, response
     */
