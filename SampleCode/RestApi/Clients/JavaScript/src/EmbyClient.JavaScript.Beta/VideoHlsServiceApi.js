...
export default class VideoHlsServiceApi {
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/VideoHlsServiceApi~getAudioByIdHlsByPlaylistidBySegmentidBySegmentcontainerCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/VideoHlsServiceApi~getAudioByIdHlsByPlaylistidBySegmentidBySegmentcontainerCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/VideoHlsServiceApi~getAudioByIdLiveM3u8Callback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:EmbyClient.JavaScript.Beta/VideoHlsServiceApi~getAudioByIdLiveM3u8Callback} callback The callback function, accepting three arguments: error, data, response
     */
