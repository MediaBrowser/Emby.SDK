...
export default class CodecParameterServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/CodecParameterServiceApi
    * @class
    ...
    */
     ...
     * @param {module:EmbyClient.JavaScript.Beta/CodecParameterServiceApi~postEncodingCodecparametersCallback} callback The callback function, accepting three arguments: error, data, response
     */
