...
export default class UserViewsServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/UserViewsServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/UserViewsServiceApi~getUsersByUseridViewsCallback
