...
export default class TrailersServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/TrailersServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/TrailersServiceApi~getTrailersCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/TrailersServiceApi~getTrailersCallback} callback The callback function, accepting three arguments: error, data, response
