...
export default class StudiosServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/StudiosServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/StudiosServiceApi~getStudiosCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/StudiosServiceApi~getStudiosCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/StudiosServiceApi~getStudiosByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/StudiosServiceApi~getStudiosByNameCallback} callback The callback function, accepting three arguments: error, data, response
