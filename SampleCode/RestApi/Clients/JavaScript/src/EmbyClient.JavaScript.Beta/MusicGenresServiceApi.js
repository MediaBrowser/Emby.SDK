...
export default class MusicGenresServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/MusicGenresServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/MusicGenresServiceApi~getMusicgenresCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/MusicGenresServiceApi~getMusicgenresCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/MusicGenresServiceApi~getMusicgenresByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript.Beta/MusicGenresServiceApi~getMusicgenresByNameCallback} callback The callback function, accepting three arguments: error, data, response
