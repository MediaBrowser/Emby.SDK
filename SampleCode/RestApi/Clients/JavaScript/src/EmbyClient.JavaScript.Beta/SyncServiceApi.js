...
export default class SyncServiceApi {
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/SyncServiceApi~headSyncJobitemsByIdFileCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Gets a sync job item file
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/SyncServiceApi~headSyncJobitemsByIdFileCallback} callback The callback function, accepting three arguments: error, data, response
     */
