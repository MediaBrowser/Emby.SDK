...
export default class LocalizationServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript.Beta/LocalizationServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationCountriesCallback
     ...
     * @param {module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationCountriesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationCulturesCallback
     * @param {String} error Error message, if any.
     ...
     * Gets known cultures
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationCulturesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationOptionsCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationOptionsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationParentalratingsCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript.Beta/LocalizationServiceApi~getLocalizationParentalratingsCallback} callback The callback function, accepting three arguments: error, data, response
