...
export default class ConfigurationServerConfiguration {
    ...
    */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('CollectionFolderIdsMigrated')) {
                obj['CollectionFolderIdsMigrated'] = ApiClient.convertToType(data['CollectionFolderIdsMigrated'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('NextUpUpgraded')) {
                obj['NextUpUpgraded'] = ApiClient.convertToType(data['NextUpUpgraded'], 'Boolean');
            }
    ...
    */
    ...
    /**
    * @member {Boolean} CollectionFolderIdsMigrated
    */
    'CollectionFolderIdsMigrated' = undefined;
    /**
    ...
    */
    ...
    /**
    * @member {Boolean} NextUpUpgraded
    */
    'NextUpUpgraded' = undefined;
    /**
