...
open class ItemLookupServiceAPI {
  ...
  "UrlFormatString" : "UrlFormatString"
    ...
    open class func getItemsByIdExternalidinfosWithRequestBuilder(_id: String) -> RequestBuilder<[ExternalIdInfo]> {
        ...
        let requestBuilder: RequestBuilder<[ExternalIdInfo]>.Type = embyclient-rest-swift-betaAPI.requestBuilderFactory.getBuilder()
  ...
  "Artists" : [ null, null ]
    ...
    open class func postItemsRemotesearchBookWithRequestBuilder(body: ProvidersRemoteSearchQueryProvidersBookInfo) -> RequestBuilder<[RemoteSearchResult]> {
        ...
        let requestBuilder: RequestBuilder<[RemoteSearchResult]>.Type = embyclient-rest-swift-betaAPI.requestBuilderFactory.getBuilder()
