...
open class SubtitleServiceAPI {
  ...
  "DownloadCount" : 6
    ...
    open class func getItemsByIdRemotesearchSubtitlesByLanguageWithRequestBuilder(_id: String, mediaSourceId: String, language: String, isPerfectMatch: Bool? = nil, isForced: Bool? = nil) -> RequestBuilder<[RemoteSubtitleInfo]> {
        ...
        let requestBuilder: RequestBuilder<[RemoteSubtitleInfo]>.Type = embyclient-rest-swift-betaAPI.requestBuilderFactory.getBuilder()
  ...
  "NewIndex" : 0
    ...
    open class func postItemsByIdRemotesearchSubtitlesBySubtitleidWithRequestBuilder(_id: String, mediaSourceId: String, subtitleId: String) -> RequestBuilder<SubtitlesSubtitleDownloadResult> {
        ...
        let requestBuilder: RequestBuilder<SubtitlesSubtitleDownloadResult>.Type = embyclient-rest-swift-betaAPI.requestBuilderFactory.getBuilder()
