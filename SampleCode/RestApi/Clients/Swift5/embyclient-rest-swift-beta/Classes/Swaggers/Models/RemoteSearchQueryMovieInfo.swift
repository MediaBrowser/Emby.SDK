//
// RemoteSearchQueryMovieInfo.swift
//
...
public struct RemoteSearchQueryMovieInfo: Codable {
    ...
    public init(searchInfo: MovieInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, providers: [String]? = nil, includeDisabledProviders: Bool? = nil) {
