//
// RemoteSearchQueryMusicVideoInfo.swift
//
...
public struct RemoteSearchQueryMusicVideoInfo: Codable {
    ...
    public init(searchInfo: MusicVideoInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, providers: [String]? = nil, includeDisabledProviders: Bool? = nil) {
