...
public struct MediaInfoPlaybackInfoRequest: Codable {
    ...
    public var directPlayProtocols: [MediaInfoMediaProtocol]?
    public var currentPlaySessionId: String?

    public init(_id: String? = nil, userId: String? = nil, maxStreamingBitrate: Int64? = nil, startTimeTicks: Int64? = nil, audioStreamIndex: Int? = nil, subtitleStreamIndex: Int? = nil, maxAudioChannels: Int? = nil, mediaSourceId: String? = nil, liveStreamId: String? = nil, deviceProfile: DlnaDeviceProfile? = nil, enableDirectPlay: Bool? = nil, enableDirectStream: Bool? = nil, enableTranscoding: Bool? = nil, allowInterlacedVideoStreamCopy: Bool? = nil, allowVideoStreamCopy: Bool? = nil, allowAudioStreamCopy: Bool? = nil, isPlayback: Bool? = nil, autoOpenLiveStream: Bool? = nil, directPlayProtocols: [MediaInfoMediaProtocol]? = nil, currentPlaySessionId: String? = nil) {
        self._id = _id
        self.userId = userId
