...
public struct ProvidersRemoteSearchQueryProvidersGameInfo: Codable {
    ...
    public init(searchInfo: ProvidersGameInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, providers: [String]? = nil, includeDisabledProviders: Bool? = nil) {
