//
// EmbyDlnaProfilesDlnaProfile.swift
//
...
public struct EmbyDlnaProfilesDlnaProfile: Codable {

    public var type: EmbyDlnaProfilesDeviceProfileType?
    ...
    public var identification: EmbyDlnaProfilesDeviceIdentification?
    public var protocolInfoDetection: EmbyDlnaProfilesProtocolInfoDetection?
    ...
    public init(type: EmbyDlnaProfilesDeviceProfileType? = nil, path: String? = nil, userId: String? = nil, albumArtPn: String? = nil, maxAlbumArtWidth: Int? = nil, maxAlbumArtHeight: Int? = nil, maxIconWidth: Int? = nil, maxIconHeight: Int? = nil, friendlyName: String? = nil, manufacturer: String? = nil, manufacturerUrl: String? = nil, modelName: String? = nil, modelDescription: String? = nil, modelNumber: String? = nil, modelUrl: String? = nil, serialNumber: String? = nil, enableAlbumArtInDidl: Bool? = nil, enableSingleAlbumArtLimit: Bool? = nil, enableSingleSubtitleLimit: Bool? = nil, protocolInfo: String? = nil, timelineOffsetSeconds: Int? = nil, requiresPlainVideoItems: Bool? = nil, requiresPlainFolders: Bool? = nil, ignoreTranscodeByteRangeRequests: Bool? = nil, supportsSamsungBookmark: Bool? = nil, identification: EmbyDlnaProfilesDeviceIdentification? = nil, protocolInfoDetection: EmbyDlnaProfilesProtocolInfoDetection? = nil, name: String? = nil, _id: String? = nil, supportedMediaTypes: String? = nil, maxStreamingBitrate: Int64? = nil, musicStreamingTranscodingBitrate: Int? = nil, maxStaticMusicBitrate: Int? = nil, directPlayProfiles: [DlnaDirectPlayProfile]? = nil, transcodingProfiles: [DlnaTranscodingProfile]? = nil, containerProfiles: [DlnaContainerProfile]? = nil, codecProfiles: [DlnaCodecProfile]? = nil, responseProfiles: [DlnaResponseProfile]? = nil, subtitleProfiles: [DlnaSubtitleProfile]? = nil) {
        self.type = type
        self.path = path
        self.userId = userId
