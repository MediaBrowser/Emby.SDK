//
// RemoteSearchQueryTrailerInfo.swift
//
...
public struct RemoteSearchQueryTrailerInfo: Codable {
    ...
    public init(searchInfo: TrailerInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, providers: [String]? = nil, includeDisabledProviders: Bool? = nil) {
