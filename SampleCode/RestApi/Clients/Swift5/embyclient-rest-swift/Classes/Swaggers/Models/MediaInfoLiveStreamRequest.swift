...
public struct MediaInfoLiveStreamRequest: Codable {
    ...
    public init(openToken: String? = nil, userId: String? = nil, playSessionId: String? = nil, maxStreamingBitrate: Int64? = nil, startTimeTicks: Int64? = nil, audioStreamIndex: Int? = nil, subtitleStreamIndex: Int? = nil, maxAudioChannels: Int? = nil, itemId: Int64? = nil, deviceProfile: DlnaDeviceProfile? = nil, enableDirectPlay: Bool? = nil, enableDirectStream: Bool? = nil, enableTranscoding: Bool? = nil, allowVideoStreamCopy: Bool? = nil, allowInterlacedVideoStreamCopy: Bool? = nil, allowAudioStreamCopy: Bool? = nil, directPlayProtocols: [MediaInfoMediaProtocol]? = nil) {
