...
open class PlaylistServiceAPI {
  ...
  "Name" : "Name"
    ...
    open class func postPlaylistsWithRequestBuilder(name: String? = nil, ids: String? = nil, mediaType: String? = nil) -> RequestBuilder<PlaylistsPlaylistCreationResult> {
        ...
        let requestBuilder: RequestBuilder<PlaylistsPlaylistCreationResult>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
  ...
  "Id" : "Id"
    ...
    open class func postPlaylistsByIdItemsWithRequestBuilder(ids: String, _id: String, userId: String? = nil) -> RequestBuilder<PlaylistsAddToPlaylistResult> {
        ...
        let requestBuilder: RequestBuilder<PlaylistsAddToPlaylistResult>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
