...
open class LiveTvServiceAPI {
  ...
  "Name" : "Name"
    ...
    open class func getLivetvChanneltagsPrefixesWithRequestBuilder(artistType: String? = nil, maxOfficialRating: String? = nil, hasThemeSong: Bool? = nil, hasThemeVideo: Bool? = nil, hasSubtitles: Bool? = nil, hasSpecialFeature: Bool? = nil, hasTrailer: Bool? = nil, adjacentTo: String? = nil, minIndexNumber: Int? = nil, minPlayers: Int? = nil, maxPlayers: Int? = nil, parentIndexNumber: Int? = nil, hasParentalRating: Bool? = nil, isHD: Bool? = nil, locationTypes: String? = nil, excludeLocationTypes: String? = nil, isMissing: Bool? = nil, isUnaired: Bool? = nil, minCommunityRating: Double? = nil, minCriticRating: Double? = nil, airedDuringSeason: Int? = nil, minPremiereDate: String? = nil, minDateLastSaved: String? = nil, minDateLastSavedForUser: String? = nil, maxPremiereDate: String? = nil, hasOverview: Bool? = nil, hasImdbId: Bool? = nil, hasTmdbId: Bool? = nil, hasTvdbId: Bool? = nil, excludeItemIds: String? = nil, startIndex: Int? = nil, limit: Int? = nil, recursive: Bool? = nil, searchTerm: String? = nil, sortOrder: String? = nil, parentId: String? = nil, fields: String? = nil, excludeItemTypes: String? = nil, includeItemTypes: String? = nil, anyProviderIdEquals: String? = nil, filters: String? = nil, isFavorite: Bool? = nil, isMovie: Bool? = nil, isSeries: Bool? = nil, isNews: Bool? = nil, isKids: Bool? = nil, isSports: Bool? = nil, mediaTypes: String? = nil, imageTypes: String? = nil, sortBy: String? = nil, isPlayed: Bool? = nil, genres: String? = nil, officialRatings: String? = nil, tags: String? = nil, years: String? = nil, enableImages: Bool? = nil, enableUserData: Bool? = nil, imageTypeLimit: Int? = nil, enableImageTypes: String? = nil, person: String? = nil, personIds: String? = nil, personTypes: String? = nil, studios: String? = nil, studioIds: String? = nil, artists: String? = nil, artistIds: String? = nil, albums: String? = nil, ids: String? = nil, videoTypes: String? = nil, containers: String? = nil, audioCodecs: String? = nil, videoCodecs: String? = nil, subtitleCodecs: String? = nil, path: String? = nil, userId: String? = nil, minOfficialRating: String? = nil, isLocked: Bool? = nil, isPlaceHolder: Bool? = nil, hasOfficialRating: Bool? = nil, groupItemsIntoCollections: Bool? = nil, is3D: Bool? = nil, seriesStatus: String? = nil, nameStartsWithOrGreater: String? = nil, artistStartsWithOrGreater: String? = nil, albumArtistStartsWithOrGreater: String? = nil, nameStartsWith: String? = nil, nameLessThan: String? = nil) -> RequestBuilder<[LiveTVApiTagItem]> {
        ...
        let requestBuilder: RequestBuilder<[LiveTVApiTagItem]>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
  ...
  "Items" : [ {
    ...
    open class func getLivetvEPGWithRequestBuilder(type: LiveTvChannelType? = nil, userId: String? = nil, genreIds: String? = nil, minStartDate: String? = nil, maxStartDate: String? = nil, minEndDate: String? = nil, maxEndDate: String? = nil, startIndex: Int? = nil, isMovie: Bool? = nil, isSeries: Bool? = nil, isNews: Bool? = nil, isKids: Bool? = nil, isSports: Bool? = nil, limit: Int? = nil, isFavorite: Bool? = nil, isLiked: Bool? = nil, isDisliked: Bool? = nil, enableFavoriteSorting: Bool? = nil, enableImages: Bool? = nil, imageTypeLimit: Int? = nil, enableImageTypes: String? = nil, fields: String? = nil, addCurrentProgram: Bool? = nil, enableUserData: Bool? = nil, channelIds: String? = nil) -> RequestBuilder<QueryResultLiveTVApiEpgRow> {
        ...
        let requestBuilder: RequestBuilder<QueryResultLiveTVApiEpgRow>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
  ...
  "Name" : "Name"
    ...
    open class func getLivetvListingprovidersAvailableWithRequestBuilder() -> RequestBuilder<[LiveTVApiListingProviderTypeInfo]> {
        ...
        let requestBuilder: RequestBuilder<[LiveTVApiListingProviderTypeInfo]>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
  ...
  "Items" : [ {
    ...
    open class func getLivetvManageChannelsWithRequestBuilder(startIndex: Int? = nil, limit: Int? = nil, sortBy: String? = nil, sortOrder: String? = nil) -> RequestBuilder<QueryResultEmbyLiveTVChannelManagementInfo> {
        ...
        let requestBuilder: RequestBuilder<QueryResultEmbyLiveTVChannelManagementInfo>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
