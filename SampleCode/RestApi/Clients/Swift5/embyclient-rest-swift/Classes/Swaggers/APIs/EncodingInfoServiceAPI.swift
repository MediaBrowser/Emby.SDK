...
open class EncodingInfoServiceAPI {
  ...
  "CodecId" : "CodecId"
    ...
    open class func getEncodingCodecconfigurationDefaultsWithRequestBuilder() -> RequestBuilder<[ConfigurationCodecConfiguration]> {
        ...
        let requestBuilder: RequestBuilder<[ConfigurationCodecConfiguration]>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
  ...
  "IsEnabledByDefault" : true
    ...
    open class func getEncodingCodecinformationVideoWithRequestBuilder() -> RequestBuilder<[MediaEncodingCodecsVideoCodecsVideoCodecBase]> {
        ...
        let requestBuilder: RequestBuilder<[MediaEncodingCodecsVideoCodecsVideoCodecBase]>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
  ...
  "IsOpenClSuperTAvailable" : true
    ...
    open class func getEncodingTonemapoptionsWithRequestBuilder() -> RequestBuilder<MediaEncodingConfigurationToneMappingToneMapOptionsVisibility> {
        ...
        let requestBuilder: RequestBuilder<MediaEncodingConfigurationToneMappingToneMapOptionsVisibility>.Type = embyclient-rest-swiftAPI.requestBuilderFactory.getBuilder()
