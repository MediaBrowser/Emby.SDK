...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQuerySeriesInfo :  IEquatable<RemoteSearchQuerySeriesInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQuerySeriesInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQuerySeriesInfo(SeriesInfo searchInfo = default(SeriesInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoteSearchQuerySeriesInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQuerySeriesInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQuerySeriesInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQuerySeriesInfo input)
        {
            if (input == null)
                return false;
