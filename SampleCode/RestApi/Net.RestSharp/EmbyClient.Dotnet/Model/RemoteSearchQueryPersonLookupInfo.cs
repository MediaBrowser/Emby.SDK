...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQueryPersonLookupInfo :  IEquatable<RemoteSearchQueryPersonLookupInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQueryPersonLookupInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQueryPersonLookupInfo(PersonLookupInfo searchInfo = default(PersonLookupInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoteSearchQueryPersonLookupInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQueryPersonLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQueryPersonLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQueryPersonLookupInfo input)
        {
            if (input == null)
                return false;
