...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RemoteSearchQueryAlbumInfo :  IEquatable<RemoteSearchQueryAlbumInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoteSearchQueryAlbumInfo" /> class.
        /// </summary>
        ...
        public RemoteSearchQueryAlbumInfo(AlbumInfo searchInfo = default(AlbumInfo), long? itemId = default(long?), string searchProviderName = default(string), List<string> providers = default(List<string>), bool? includeDisabledProviders = default(bool?))
        {
        ...
        {
            return this.Equals(input as RemoteSearchQueryAlbumInfo);
        }

        /// <summary>
        /// Returns true if RemoteSearchQueryAlbumInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of RemoteSearchQueryAlbumInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RemoteSearchQueryAlbumInfo input)
        {
            if (input == null)
                return false;
