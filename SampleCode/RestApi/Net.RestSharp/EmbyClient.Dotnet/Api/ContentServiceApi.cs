...
namespace EmbyClient.Dotnet.Api
{
    ...
    /// </summary>
        public interface IContentServiceApi : IApiAccessor
    {
        ...
        /// <returns>List&lt;ContentSection&gt;</returns>
        List<ContentSection> GetUsersByUseridHomesections (string userId);
        ...
        /// <exception cref="EmbyClient.Dotnet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of List&lt;ContentSection&gt;</returns>
        ApiResponse<List<ContentSection>> GetUsersByUseridHomesectionsWithHttpInfo (string userId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<QueryResultBaseItemDto> GetUsersByUseridSectionsBySectionidItemsWithHttpInfo (string sectionId, string artistType, string maxOfficialRating, bool? hasThemeSong, bool? hasThemeVideo, bool? hasSubtitles, bool? hasSpecialFeature, bool? hasTrailer, bool? isSpecialSeason, string adjacentTo, string startItemId, int? minIndexNumber, DateTimeOffset? minStartDate, DateTimeOffset? maxStartDate, DateTimeOffset? minEndDate, DateTimeOffset? maxEndDate, int? minPlayers, int? maxPlayers, int? parentIndexNumber, bool? hasParentalRating, bool? isHD, bool? isUnaired, double? minCommunityRating, double? minCriticRating, int? airedDuringSeason, DateTimeOffset? minPremiereDate, DateTimeOffset? minDateLastSaved, DateTimeOffset? minDateLastSavedForUser, DateTimeOffset? maxPremiereDate, bool? hasOverview, bool? hasImdbId, bool? hasTmdbId, bool? hasTvdbId, string excludeItemIds, int? startIndex, int? limit, bool? recursive, string searchTerm, string sortOrder, string parentId, string fields, string excludeItemTypes, string includeItemTypes, string anyProviderIdEquals, string filters, bool? isFavorite, bool? isMovie, bool? isSeries, bool? isFolder, bool? isNews, bool? isKids, bool? isSports, bool? isNew, bool? isPremiere, bool? isNewOrPremiere, bool? isRepeat, bool? projectToMedia, string mediaTypes, string imageTypes, string sortBy, bool? isPlayed, string genres, string officialRatings, string tags, string excludeTags, string years, bool? enableImages, bool? enableUserData, int? imageTypeLimit, string enableImageTypes, string person, string personIds, string personTypes, string studios, string studioIds, string artists, string artistIds, string albums, string ids, string videoTypes, string containers, string audioCodecs, string audioLayouts, string videoCodecs, string extendedVideoTypes, string subtitleCodecs, string path, string userId, string minOfficialRating, bool? isLocked, bool? isPlaceHolder, bool? hasOfficialRating, bool? groupItemsIntoCollections, bool? is3D, string seriesStatus, string nameStartsWithOrGreater, string artistStartsWithOrGreater, string albumArtistStartsWithOrGreater, string nameStartsWith, string nameLessThan);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        void PostUsersByUseridHomesections (ContentSection body, string userId);
        ...
        ApiResponse<Object> PostUsersByUseridHomesectionsWithHttpInfo (ContentSection body, string userId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        void PostUsersByUseridHomesectionsDelete (UserLibraryDeleteHomeSections body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> PostUsersByUseridHomesectionsDeleteWithHttpInfo (UserLibraryDeleteHomeSections body, string userId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        void PostUsersByUseridHomesectionsMove (UserLibraryMoveHomeSections body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> PostUsersByUseridHomesectionsMoveWithHttpInfo (UserLibraryMoveHomeSections body, string userId);
        ...
        /// <exception cref="EmbyClient.Dotnet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">User Id</param>
        /// <returns>Task of List&lt;ContentSection&gt;</returns>
        System.Threading.Tasks.Task<List<ContentSection>> GetUsersByUseridHomesectionsAsync (string userId);
        ...
        /// <exception cref="EmbyClient.Dotnet.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse (List&lt;ContentSection&gt;)</returns>
        System.Threading.Tasks.Task<ApiResponse<List<ContentSection>>> GetUsersByUseridHomesectionsAsyncWithHttpInfo (string userId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<QueryResultBaseItemDto> GetUsersByUseridSectionsBySectionidItemsAsync (string sectionId, string artistType, string maxOfficialRating, bool? hasThemeSong, bool? hasThemeVideo, bool? hasSubtitles, bool? hasSpecialFeature, bool? hasTrailer, bool? isSpecialSeason, string adjacentTo, string startItemId, int? minIndexNumber, DateTimeOffset? minStartDate, DateTimeOffset? maxStartDate, DateTimeOffset? minEndDate, DateTimeOffset? maxEndDate, int? minPlayers, int? maxPlayers, int? parentIndexNumber, bool? hasParentalRating, bool? isHD, bool? isUnaired, double? minCommunityRating, double? minCriticRating, int? airedDuringSeason, DateTimeOffset? minPremiereDate, DateTimeOffset? minDateLastSaved, DateTimeOffset? minDateLastSavedForUser, DateTimeOffset? maxPremiereDate, bool? hasOverview, bool? hasImdbId, bool? hasTmdbId, bool? hasTvdbId, string excludeItemIds, int? startIndex, int? limit, bool? recursive, string searchTerm, string sortOrder, string parentId, string fields, string excludeItemTypes, string includeItemTypes, string anyProviderIdEquals, string filters, bool? isFavorite, bool? isMovie, bool? isSeries, bool? isFolder, bool? isNews, bool? isKids, bool? isSports, bool? isNew, bool? isPremiere, bool? isNewOrPremiere, bool? isRepeat, bool? projectToMedia, string mediaTypes, string imageTypes, string sortBy, bool? isPlayed, string genres, string officialRatings, string tags, string excludeTags, string years, bool? enableImages, bool? enableUserData, int? imageTypeLimit, string enableImageTypes, string person, string personIds, string personTypes, string studios, string studioIds, string artists, string artistIds, string albums, string ids, string videoTypes, string containers, string audioCodecs, string audioLayouts, string videoCodecs, string extendedVideoTypes, string subtitleCodecs, string path, string userId, string minOfficialRating, bool? isLocked, bool? isPlaceHolder, bool? hasOfficialRating, bool? groupItemsIntoCollections, bool? is3D, string seriesStatus, string nameStartsWithOrGreater, string artistStartsWithOrGreater, string albumArtistStartsWithOrGreater, string nameStartsWith, string nameLessThan);
        ...
        System.Threading.Tasks.Task<ApiResponse<QueryResultBaseItemDto>> GetUsersByUseridSectionsBySectionidItemsAsyncWithHttpInfo (string sectionId, string artistType, string maxOfficialRating, bool? hasThemeSong, bool? hasThemeVideo, bool? hasSubtitles, bool? hasSpecialFeature, bool? hasTrailer, bool? isSpecialSeason, string adjacentTo, string startItemId, int? minIndexNumber, DateTimeOffset? minStartDate, DateTimeOffset? maxStartDate, DateTimeOffset? minEndDate, DateTimeOffset? maxEndDate, int? minPlayers, int? maxPlayers, int? parentIndexNumber, bool? hasParentalRating, bool? isHD, bool? isUnaired, double? minCommunityRating, double? minCriticRating, int? airedDuringSeason, DateTimeOffset? minPremiereDate, DateTimeOffset? minDateLastSaved, DateTimeOffset? minDateLastSavedForUser, DateTimeOffset? maxPremiereDate, bool? hasOverview, bool? hasImdbId, bool? hasTmdbId, bool? hasTvdbId, string excludeItemIds, int? startIndex, int? limit, bool? recursive, string searchTerm, string sortOrder, string parentId, string fields, string excludeItemTypes, string includeItemTypes, string anyProviderIdEquals, string filters, bool? isFavorite, bool? isMovie, bool? isSeries, bool? isFolder, bool? isNews, bool? isKids, bool? isSports, bool? isNew, bool? isPremiere, bool? isNewOrPremiere, bool? isRepeat, bool? projectToMedia, string mediaTypes, string imageTypes, string sortBy, bool? isPlayed, string genres, string officialRatings, string tags, string excludeTags, string years, bool? enableImages, bool? enableUserData, int? imageTypeLimit, string enableImageTypes, string person, string personIds, string personTypes, string studios, string studioIds, string artists, string artistIds, string albums, string ids, string videoTypes, string containers, string audioCodecs, string audioLayouts, string videoCodecs, string extendedVideoTypes, string subtitleCodecs, string path, string userId, string minOfficialRating, bool? isLocked, bool? isPlaceHolder, bool? hasOfficialRating, bool? groupItemsIntoCollections, bool? is3D, string seriesStatus, string nameStartsWithOrGreater, string artistStartsWithOrGreater, string albumArtistStartsWithOrGreater, string nameStartsWith, string nameLessThan);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task PostUsersByUseridHomesectionsAsync (ContentSection body, string userId);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridHomesectionsAsyncWithHttpInfo (ContentSection body, string userId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task PostUsersByUseridHomesectionsDeleteAsync (UserLibraryDeleteHomeSections body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridHomesectionsDeleteAsyncWithHttpInfo (UserLibraryDeleteHomeSections body, string userId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task PostUsersByUseridHomesectionsMoveAsync (UserLibraryMoveHomeSections body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridHomesectionsMoveAsyncWithHttpInfo (UserLibraryMoveHomeSections body, string userId);
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class ContentServiceApi : IContentServiceApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ContentServiceApi(String basePath)
        {
        ...
        /// <returns></returns>
        public ContentServiceApi(EmbyClient.Dotnet.Client.Configuration configuration = null)
        {
        ...
        /// <param name="userId">User Id</param>
        /// <returns>List&lt;ContentSection&gt;</returns>
        public List<ContentSection> GetUsersByUseridHomesections (string userId)
        {
             ApiResponse<List<ContentSection>> localVarResponse = GetUsersByUseridHomesectionsWithHttpInfo(userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of List&lt;ContentSection&gt;</returns>
        public ApiResponse< List<ContentSection> > GetUsersByUseridHomesectionsWithHttpInfo (string userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling ContentServiceApi->GetUsersByUseridHomesections");

            var localVarPath = "/Users/{UserId}/HomeSections";
            ...
            {
                Exception exception = ExceptionFactory("GetUsersByUseridHomesections", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<List<ContentSection>>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (List<ContentSection>) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(List<ContentSection>)));
        }
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of List&lt;ContentSection&gt;</returns>
        public async System.Threading.Tasks.Task<List<ContentSection>> GetUsersByUseridHomesectionsAsync (string userId)
        {
             ApiResponse<List<ContentSection>> localVarResponse = await GetUsersByUseridHomesectionsAsyncWithHttpInfo(userId);
             return localVarResponse.Data;
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse (List&lt;ContentSection&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<ContentSection>>> GetUsersByUseridHomesectionsAsyncWithHttpInfo (string userId)
        {
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling ContentServiceApi->GetUsersByUseridHomesections");
        ...
        /// <param name="nameLessThan">Optional filter by items whose name is equally or lesser than a given input string. (optional)</param>
        /// <returns>ApiResponse of QueryResultBaseItemDto</returns>
        public ApiResponse< QueryResultBaseItemDto > GetUsersByUseridSectionsBySectionidItemsWithHttpInfo (string sectionId, string artistType, string maxOfficialRating, bool? hasThemeSong, bool? hasThemeVideo, bool? hasSubtitles, bool? hasSpecialFeature, bool? hasTrailer, bool? isSpecialSeason, string adjacentTo, string startItemId, int? minIndexNumber, DateTimeOffset? minStartDate, DateTimeOffset? maxStartDate, DateTimeOffset? minEndDate, DateTimeOffset? maxEndDate, int? minPlayers, int? maxPlayers, int? parentIndexNumber, bool? hasParentalRating, bool? isHD, bool? isUnaired, double? minCommunityRating, double? minCriticRating, int? airedDuringSeason, DateTimeOffset? minPremiereDate, DateTimeOffset? minDateLastSaved, DateTimeOffset? minDateLastSavedForUser, DateTimeOffset? maxPremiereDate, bool? hasOverview, bool? hasImdbId, bool? hasTmdbId, bool? hasTvdbId, string excludeItemIds, int? startIndex, int? limit, bool? recursive, string searchTerm, string sortOrder, string parentId, string fields, string excludeItemTypes, string includeItemTypes, string anyProviderIdEquals, string filters, bool? isFavorite, bool? isMovie, bool? isSeries, bool? isFolder, bool? isNews, bool? isKids, bool? isSports, bool? isNew, bool? isPremiere, bool? isNewOrPremiere, bool? isRepeat, bool? projectToMedia, string mediaTypes, string imageTypes, string sortBy, bool? isPlayed, string genres, string officialRatings, string tags, string excludeTags, string years, bool? enableImages, bool? enableUserData, int? imageTypeLimit, string enableImageTypes, string person, string personIds, string personTypes, string studios, string studioIds, string artists, string artistIds, string albums, string ids, string videoTypes, string containers, string audioCodecs, string audioLayouts, string videoCodecs, string extendedVideoTypes, string subtitleCodecs, string path, string userId, string minOfficialRating, bool? isLocked, bool? isPlaceHolder, bool? hasOfficialRating, bool? groupItemsIntoCollections, bool? is3D, string seriesStatus, string nameStartsWithOrGreater, string artistStartsWithOrGreater, string albumArtistStartsWithOrGreater, string nameStartsWith, string nameLessThan)
        {
            // verify the required parameter 'sectionId' is set
            if (sectionId == null)
                throw new ApiException(400, "Missing required parameter 'sectionId' when calling ContentServiceApi->GetUsersByUseridSectionsBySectionidItems");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling ContentServiceApi->GetUsersByUseridSectionsBySectionidItems");

            var localVarPath = "/Users/{UserId}/Sections/{SectionId}/Items";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (sectionId != null) localVarPathParams.Add("SectionId", this.Configuration.ApiClient.ParameterToString(sectionId)); // path parameter
            if (userId != null) localVarPathParams.Add("UserId", this.Configuration.ApiClient.ParameterToString(userId)); // path parameter
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetUsersByUseridSectionsBySectionidItems", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="nameLessThan">Optional filter by items whose name is equally or lesser than a given input string. (optional)</param>
        /// <returns>Task of QueryResultBaseItemDto</returns>
        public async System.Threading.Tasks.Task<QueryResultBaseItemDto> GetUsersByUseridSectionsBySectionidItemsAsync (string sectionId, string artistType, string maxOfficialRating, bool? hasThemeSong, bool? hasThemeVideo, bool? hasSubtitles, bool? hasSpecialFeature, bool? hasTrailer, bool? isSpecialSeason, string adjacentTo, string startItemId, int? minIndexNumber, DateTimeOffset? minStartDate, DateTimeOffset? maxStartDate, DateTimeOffset? minEndDate, DateTimeOffset? maxEndDate, int? minPlayers, int? maxPlayers, int? parentIndexNumber, bool? hasParentalRating, bool? isHD, bool? isUnaired, double? minCommunityRating, double? minCriticRating, int? airedDuringSeason, DateTimeOffset? minPremiereDate, DateTimeOffset? minDateLastSaved, DateTimeOffset? minDateLastSavedForUser, DateTimeOffset? maxPremiereDate, bool? hasOverview, bool? hasImdbId, bool? hasTmdbId, bool? hasTvdbId, string excludeItemIds, int? startIndex, int? limit, bool? recursive, string searchTerm, string sortOrder, string parentId, string fields, string excludeItemTypes, string includeItemTypes, string anyProviderIdEquals, string filters, bool? isFavorite, bool? isMovie, bool? isSeries, bool? isFolder, bool? isNews, bool? isKids, bool? isSports, bool? isNew, bool? isPremiere, bool? isNewOrPremiere, bool? isRepeat, bool? projectToMedia, string mediaTypes, string imageTypes, string sortBy, bool? isPlayed, string genres, string officialRatings, string tags, string excludeTags, string years, bool? enableImages, bool? enableUserData, int? imageTypeLimit, string enableImageTypes, string person, string personIds, string personTypes, string studios, string studioIds, string artists, string artistIds, string albums, string ids, string videoTypes, string containers, string audioCodecs, string audioLayouts, string videoCodecs, string extendedVideoTypes, string subtitleCodecs, string path, string userId, string minOfficialRating, bool? isLocked, bool? isPlaceHolder, bool? hasOfficialRating, bool? groupItemsIntoCollections, bool? is3D, string seriesStatus, string nameStartsWithOrGreater, string artistStartsWithOrGreater, string albumArtistStartsWithOrGreater, string nameStartsWith, string nameLessThan)
        {
             ApiResponse<QueryResultBaseItemDto> localVarResponse = await GetUsersByUseridSectionsBySectionidItemsAsyncWithHttpInfo(sectionId, artistType, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, isSpecialSeason, adjacentTo, startItemId, minIndexNumber, minStartDate, maxStartDate, minEndDate, maxEndDate, minPlayers, maxPlayers, parentIndexNumber, hasParentalRating, isHD, isUnaired, minCommunityRating, minCriticRating, airedDuringSeason, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, anyProviderIdEquals, filters, isFavorite, isMovie, isSeries, isFolder, isNews, isKids, isSports, isNew, isPremiere, isNewOrPremiere, isRepeat, projectToMedia, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, excludeTags, years, enableImages, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, studioIds, artists, artistIds, albums, ids, videoTypes, containers, audioCodecs, audioLayouts, videoCodecs, extendedVideoTypes, subtitleCodecs, path, userId, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, groupItemsIntoCollections, is3D, seriesStatus, nameStartsWithOrGreater, artistStartsWithOrGreater, albumArtistStartsWithOrGreater, nameStartsWith, nameLessThan);
             return localVarResponse.Data;
        ...
        /// <param name="nameLessThan">Optional filter by items whose name is equally or lesser than a given input string. (optional)</param>
        /// <returns>Task of ApiResponse (QueryResultBaseItemDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<QueryResultBaseItemDto>> GetUsersByUseridSectionsBySectionidItemsAsyncWithHttpInfo (string sectionId, string artistType, string maxOfficialRating, bool? hasThemeSong, bool? hasThemeVideo, bool? hasSubtitles, bool? hasSpecialFeature, bool? hasTrailer, bool? isSpecialSeason, string adjacentTo, string startItemId, int? minIndexNumber, DateTimeOffset? minStartDate, DateTimeOffset? maxStartDate, DateTimeOffset? minEndDate, DateTimeOffset? maxEndDate, int? minPlayers, int? maxPlayers, int? parentIndexNumber, bool? hasParentalRating, bool? isHD, bool? isUnaired, double? minCommunityRating, double? minCriticRating, int? airedDuringSeason, DateTimeOffset? minPremiereDate, DateTimeOffset? minDateLastSaved, DateTimeOffset? minDateLastSavedForUser, DateTimeOffset? maxPremiereDate, bool? hasOverview, bool? hasImdbId, bool? hasTmdbId, bool? hasTvdbId, string excludeItemIds, int? startIndex, int? limit, bool? recursive, string searchTerm, string sortOrder, string parentId, string fields, string excludeItemTypes, string includeItemTypes, string anyProviderIdEquals, string filters, bool? isFavorite, bool? isMovie, bool? isSeries, bool? isFolder, bool? isNews, bool? isKids, bool? isSports, bool? isNew, bool? isPremiere, bool? isNewOrPremiere, bool? isRepeat, bool? projectToMedia, string mediaTypes, string imageTypes, string sortBy, bool? isPlayed, string genres, string officialRatings, string tags, string excludeTags, string years, bool? enableImages, bool? enableUserData, int? imageTypeLimit, string enableImageTypes, string person, string personIds, string personTypes, string studios, string studioIds, string artists, string artistIds, string albums, string ids, string videoTypes, string containers, string audioCodecs, string audioLayouts, string videoCodecs, string extendedVideoTypes, string subtitleCodecs, string path, string userId, string minOfficialRating, bool? isLocked, bool? isPlaceHolder, bool? hasOfficialRating, bool? groupItemsIntoCollections, bool? is3D, string seriesStatus, string nameStartsWithOrGreater, string artistStartsWithOrGreater, string albumArtistStartsWithOrGreater, string nameStartsWith, string nameLessThan)
        {
            // verify the required parameter 'sectionId' is set
            if (sectionId == null)
                throw new ApiException(400, "Missing required parameter 'sectionId' when calling ContentServiceApi->GetUsersByUseridSectionsBySectionidItems");
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        public void PostUsersByUseridHomesections (ContentSection body, string userId)
        {
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PostUsersByUseridHomesectionsWithHttpInfo (ContentSection body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContentServiceApi->PostUsersByUseridHomesections");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling ContentServiceApi->PostUsersByUseridHomesections");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostUsersByUseridHomesections", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostUsersByUseridHomesectionsAsync (ContentSection body, string userId)
        {
             await PostUsersByUseridHomesectionsAsyncWithHttpInfo(body, userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridHomesectionsAsyncWithHttpInfo (ContentSection body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContentServiceApi->PostUsersByUseridHomesections");
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        public void PostUsersByUseridHomesectionsDelete (UserLibraryDeleteHomeSections body, string userId)
        {
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PostUsersByUseridHomesectionsDeleteWithHttpInfo (UserLibraryDeleteHomeSections body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContentServiceApi->PostUsersByUseridHomesectionsDelete");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling ContentServiceApi->PostUsersByUseridHomesectionsDelete");

            var localVarPath = "/Users/{UserId}/HomeSections/Delete";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostUsersByUseridHomesectionsDelete", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostUsersByUseridHomesectionsDeleteAsync (UserLibraryDeleteHomeSections body, string userId)
        {
             await PostUsersByUseridHomesectionsDeleteAsyncWithHttpInfo(body, userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridHomesectionsDeleteAsyncWithHttpInfo (UserLibraryDeleteHomeSections body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContentServiceApi->PostUsersByUseridHomesectionsDelete");
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        public void PostUsersByUseridHomesectionsMove (UserLibraryMoveHomeSections body, string userId)
        {
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PostUsersByUseridHomesectionsMoveWithHttpInfo (UserLibraryMoveHomeSections body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContentServiceApi->PostUsersByUseridHomesectionsMove");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling ContentServiceApi->PostUsersByUseridHomesectionsMove");

            var localVarPath = "/Users/{UserId}/HomeSections/Move";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostUsersByUseridHomesectionsMove", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostUsersByUseridHomesectionsMoveAsync (UserLibraryMoveHomeSections body, string userId)
        {
             await PostUsersByUseridHomesectionsMoveAsyncWithHttpInfo(body, userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridHomesectionsMoveAsyncWithHttpInfo (UserLibraryMoveHomeSections body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContentServiceApi->PostUsersByUseridHomesectionsMove");
