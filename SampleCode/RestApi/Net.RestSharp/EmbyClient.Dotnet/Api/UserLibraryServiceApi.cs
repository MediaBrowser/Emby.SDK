...
namespace EmbyClient.Dotnet.Api
{
        ...
        public interface IUserLibraryServiceApi : IApiAccessor
    {
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        void PostUsersByUseridSearcheditems (UserLibraryReportItemsSearched body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> PostUsersByUseridSearcheditemsWithHttpInfo (UserLibraryReportItemsSearched body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        System.Threading.Tasks.Task PostUsersByUseridSearcheditemsAsync (UserLibraryReportItemsSearched body, string userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridSearcheditemsAsyncWithHttpInfo (UserLibraryReportItemsSearched body, string userId);
        ...
        public partial class UserLibraryServiceApi : IUserLibraryServiceApi
    {
        ...
        /// <param name="userId">User Id</param>
        /// <returns></returns>
        public void PostUsersByUseridSearcheditems (UserLibraryReportItemsSearched body, string userId)
        {
        ...
        /// <param name="userId">User Id</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> PostUsersByUseridSearcheditemsWithHttpInfo (UserLibraryReportItemsSearched body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling UserLibraryServiceApi->PostUsersByUseridSearcheditems");
            // verify the required parameter 'userId' is set
            if (userId == null)
                throw new ApiException(400, "Missing required parameter 'userId' when calling UserLibraryServiceApi->PostUsersByUseridSearcheditems");

            var localVarPath = "/Users/{UserId}/SearchedItems/";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PostUsersByUseridSearcheditems", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostUsersByUseridSearcheditemsAsync (UserLibraryReportItemsSearched body, string userId)
        {
             await PostUsersByUseridSearcheditemsAsyncWithHttpInfo(body, userId);
        ...
        /// <param name="userId">User Id</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> PostUsersByUseridSearcheditemsAsyncWithHttpInfo (UserLibraryReportItemsSearched body, string userId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling UserLibraryServiceApi->PostUsersByUseridSearcheditems");
