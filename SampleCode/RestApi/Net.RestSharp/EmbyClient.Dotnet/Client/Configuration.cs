...
namespace EmbyClient.Dotnet.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "4.9.2.4";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "/4.9.2.4/dotnet"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 4.9.2.4\n";
            report += "    SDK Package Version: 4.9.2.4\n";
